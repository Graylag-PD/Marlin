...
#define STRING_CONFIG_H_AUTHOR "PDL-M2.0.8-S4" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 6	//ESP3D primary port
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 1	//TFT dedicated port - to be used with ESP3D 3.0 for testing purposes
...
#define CUSTOM_MACHINE_NAME "DRR200-32-S4XSPI_dev"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "1331b0ba-a97b-48a2-a10b-43fd4a36cebd"
...
//#define PSU_NAME "Power Supply"
  ...
  #define PSU_POWEROFF_GCODE "M355 S0\nM141 S50;"  // G-code to run before power-off (e.g., case light off)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 73.83
  #define DEFAULT_bedKi 13.57
  #define DEFAULT_bedKd 267.77
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 261.5        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 251.80             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.56, -0.47 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 124.55              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.76, -0.36, -0.40 } // Get these values from G33 auto calibrate

  // Delta radius and diagonal rod adjustments (mm)
  //#define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER { -0.16, 0.4, -0.23 }
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 405, 405 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 40, 40 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 6000, 10000, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 1.24 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, -100, 20 }
