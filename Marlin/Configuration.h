...
#define STRING_CONFIG_H_AUTHOR "Pavel Dolejsi" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "DRR210"
 ...
 */
#define PSU_CONTROL
#define PSU_NAME "RSP-150-24 (dual)"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 23.1333
    #define DEFAULT_Ki 1.7850
    #define DEFAULT_Kd 74.9520
  #endif
#endif
...
#define DELTA
  ...
  #define DELTA_MAX_RADIUS       110.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 260.0761        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 277.2761             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -1.7184, 0.0, -0.3595 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 122.7651              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 1.1049, -0.4246, -0.6804 } // Get these values from G33 auto calibrate

  // Delta radius and diagonal rod adjustments (mm)
  //#define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.7019, -0.1454, -0.5566 }
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 1620, 1620 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 160, 160 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 3000, 10000 , 10000 }
 ...
 */
#define Z_MIN_PROBE_PIN PG15 // Pin 32 is the RAMPS default
