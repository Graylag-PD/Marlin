...
#define MAX31865_SENSOR_WIRES_0 4                 // (2-4) Number of wires for the probe connected to a MAX31865 board.
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  //#define USE_OCR2A_AS_TOP
    ...
    #else
      #define FAST_PWM_FAN_FREQUENCY 25000U
    #endif
  #endif
#endif
...
//#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_Y  39          // (Hz) The default dominant resonant frequency on the Y axis.
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.045, 0.045, 0.045 } // (linear=mm, rotational=°) One value for each linear axis
  ...
  #define BACKLASH_SMOOTHING_MM 0.03 // (mm)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 20*60, 20*60, 20*60, 6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_GREEN      80  // User defined GREEN value
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.35, 0.35 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
...
#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP          100   // (mm) Default swap retract length (positive value)
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_RETRACT_SPEED   (80*60) // (mm/min) (Unloading)
    ...
    #define TOOLCHANGE_FS_PRIME_SPEED    (8*60) // (mm/min) Extra priming feedrate
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            35 // (mm) Initial retract.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         300  // (mm) Length to extrude after loading.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       50  // (mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY       200  // (ms) Delay for the filament to cool after retract.
