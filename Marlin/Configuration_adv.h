...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PD14                  // Override the default pin if needed
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.045, 0.045, 0.045 } // (mm) One value for each linear axis
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE_XYZ 20*60
  #define MANUAL_FEEDRATE { MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, 360 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panelom panel
